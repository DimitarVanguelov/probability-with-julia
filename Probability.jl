...
# ╔═╡ c3de8c2d-ba7f-4ef7-a3e5-ceee6c79411c
flush = collect(Hands)[length.(unique.([getfield.(collect(h), 2) for h in Hands])) .== 1] |> Set

# ╔═╡ 4eef87b3-67d4-419d-964f-127fbabebda3
P(flush, Hands)

# ╔═╡ 5b0102b0-fb46-4a22-a995-3d823630456f
...
note(md"*Experiment a bit in the cell above -- see what happens if you change the comma to a `for` in the array comprehension, or see what happens when you execute `deck[:]`, or wrap it in `Set()`, etc.*")
